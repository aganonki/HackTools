...
namespace AgaHackTools.Main.Helpers
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Downloads the XML object.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="url">The URL.</param>
        /// <param name="throwExceptions">if set to <c>true</c> [throw exceptions].</param>
        /// <returns></returns>
        public static T DownloadXmlObject<T>(string url, bool throwExceptions = false)
        {
            using (var webClient = new WebClient())
            {
                var downloadString = webClient.DownloadString(url);
                return ImportFromXmlString<T>(downloadString);
            }
        }
