...
namespace AgaHackTools.Main.Hook.WndProc
{
    ...
    public class WindowHook
    {
        ...
        public WindowHook(IntPtr windowHandle, string name, IWindowEngine engine)
        {
        ...
        public void Enable()
        {
            ...
            OriginalCallbackAddress = NativeMethods.SetWindowLong(WindowHandle, GwlWndproc, OurCallBackAddress);
            // Just to be sure.
        ...
        public void Disable()
        {
            ...
            NativeMethods.SetWindowLong(WindowHandle, GwlWndproc, OriginalCallbackAddress);
            OurCallBack = null;
            IsEnabled = false;
        }
        ...
        {
            NativeMethods.SendMessage(WindowHandle, (uint) WmUser, (UIntPtr) message, new IntPtr(0));
        }
        ...
        private int WndProc(IntPtr hWnd, int msg, int wParam, int lParam)
        {
            ...
            return NativeMethods.CallWindowProc(OriginalCallbackAddress, hWnd, msg, wParam, lParam);
        }
