...
namespace AgaHackTools.Example.Shared
{
    public static class Offsets
    {
        ...
        public const int m_iLifeState = 0x25B;
        public const int m_angEye = 0xA9EC;
        public const int m_pClientRenderable = 0x4;
        public static int m_pClientNetworkable = 0x8;
        #endregion
        ...
        public const int m_iWeaponID = 0x32Dc;
